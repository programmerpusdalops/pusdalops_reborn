...
const DokumenPage = () => {
  ...
  return (
    ...
    <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
      ...
      <Select label="--Tahun--" onChange={(e: { target: { value: SetStateAction<string>; }; }) => setKeyword(e.target.value)} option={[{value: "2021", label: "2021"}, {value: "2024", label: "2024"}, {value: "2023", label: "2023"}, {value: "2022", label: "2022"},]}/>
      <div>
          <input
            type="text"
