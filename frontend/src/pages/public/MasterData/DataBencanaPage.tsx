...
import ExportBencana from '../../../components/Module/ExportBencana';
      ...
      <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-5">
        <div className="flex flex-row justify-between">
          <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
            ...
            <button
              onClick={clear}
              className="flex w-full xl:w-auto justify-center rounded border border-primary px-5 p-2 font-medium text-primary"
            >
              Clear
            </button>
            <ExportBencana kejadian={bencana}/>
          </div>
        </div>
                ...
                <tr key={value?.id}>
                  ...
                  {/* <td className="border-b border-[#eee] py-3 px-4 dark:border-strokedark">
                    {value?.status_ditangani === "Ya" ? (
                        <p className="inline-flex rounded-full bg-success bg-opacity-10 py-1 px-3 text-sm font-medium text-success">Sudah Ditanagani</p>
                      ) : (
                  ...
                  <td className="border-b border-[#eee] py-3 px-4 dark:border-strokedark">
                    <div className="flex justify-between">
                      <NavLink
                        to={`/detail-data-bencana-publik/${value?.id_kejadian}`}
