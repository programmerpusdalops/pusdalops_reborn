...
export default function UbahBeritaPage() {
  ...
  const OnSubmit = async (e: { preventDefault: () => void; }) => {
    ...
    const formData = new FormData();
      ...
      try {
        await api.patchBerita(id, formData)
        Success()
      } catch (error) {
        Error()
      }
  ...
  return (
    <>
    <Breadcrumb pageName="Ubah Berita" />
          ...
          <form onSubmit={OnSubmit}>
            <div className="flex flex-col gap-5.5 p-6.5">
              ...
              <div className="flex gap-3 justify-end">
                <Link to="/berita" className="px-5 py-2 border border-primary rounded-md text-primary hover:text-button-primary hover:border-button-primary dark:text-bodydark dark:border-form-strokedark dark:hover:text-white dark:hover:border-white dark:hover:bg-transparent">
                  Kembali
                </Link>
                <button
                  type="submit"
