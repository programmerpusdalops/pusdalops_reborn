...
//   useEffect(() => {
//     const JenisInfografis = async () => {
//       const response = await api.fetchJenisInfografis();
//       setJenisInfografis(response.data);
//     };
//     JenisInfografis()
//   }, [])
  ...
  const Clear = () => {
    setItem({...item, judul: "", tahun: "", id_jenis_infografis: ""})
    setIds(null)
  }
  ...
  return (
    <>
      <Breadcrumb pageName="Infografis Page" />
...
//   return (
//     <>
//     <Breadcrumb pageName="Infografis Bencana Page" />
...
//                     </td>
//                     <td className="border-b border-[#eee] py-3 px-4 dark:border-strokedark">
//                       <p className="text-black dark:text-white">{value?.keterangan}</p>
//                     </td>
//                     {/* <td className="border-b border-[#eee] py-3 px-4 dark:border-strokedark">
